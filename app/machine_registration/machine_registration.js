...
$scope.machineregistration = {id: null,machine_name:"",machine_model:"",controller_type:"",machine_serial_no:"",machine_type:"",machine_ip:"",unit:"",device_id:"",tenant_id: null,dis_min:"",
dis_sec:"",dis_tot:""};
...
$http({
   ...
   $('#machine').modal('hide');
    ...
    $scope.newmachine2 = function(){  


      $scope.machineregistration.dis_tot = $scope.machineregistration.dis_min * 60 
      console.log($scope.machineregistration.dis_tot)

      $scope.machineregistration.dis_tot = ( +$scope.machineregistration.dis_sec ) +  $scope.machineregistration.dis_tot 
      ...
      var i;
         for(i in $rootScope.machines) {
                  ...
                  if($rootScope.machines[i].id == id) {
                     var machine_id=$rootScope.machines[i];
                     $scope.machineregistration = angular.copy(machine_id);
                     console.log($scope.machineregistration)
                  }
