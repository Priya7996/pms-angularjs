...
$http({
    ...
    method:'GET',
    url:$rootScope.api_url+'api/v1/shifts?tenant_id='+$rootScope.tenant
  })
 ...
 $scope.shiftdetails= response.data;
  ...
  $http({
    ...
    method:'GET',
    url:$rootScope.api_url+'api/v1/shifttransactions?shift_id='+$scope.shiftdetails.id+'&tenant_id='+$rootScope.tenant
...
$scope.shifttransaction = {id:null,shift_start_time:"",shift_end_time:"",actual_working_hours:"",shift_id:null,start_day:"",end_day:"",shift_no:null,shift_start_time_dummy:"",tenant_id: $scope.tenant_id,shift_end_time_dummy:"",actual_working_hours_dummy:"" };//,tenant_id: $scope.tenant_id};
